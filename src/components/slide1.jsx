...
export function Slide3() {
  return (
    <div className="relative slide3  isolate w-full xl:h-[90vh] px-8 lg:px-12 ">
      <div
        className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
        aria-hidden="true"
      >
      ...
      <div className=" max-w-2xl  bg-primary mt-4 lg:bg-opacity-15 bg-opacity-55   shadow rounded-lg   py-[10vh] lg:py-24 sm:py-48">
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-slate-200 lg:text-gray-900 sm:text-6xl">
            Get Stitched Up in Style.
          </h1>
          <h1 className="text-2xl  tracking-tight text-slate-200 lg:text-gray-900 sm:text-4xl py-6">
            {company_profile.name} Coming Soon!{" "}
          </h1>
